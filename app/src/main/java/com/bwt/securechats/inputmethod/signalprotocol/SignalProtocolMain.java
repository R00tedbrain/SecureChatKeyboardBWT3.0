...
public class SignalProtocolMain {
  ...
  /**
   * Modified encrypt method implementing option 1: catch NoSessionException.
   */
  private MessageEnvelope encrypt(final String unencryptedMessage, final SignalProtocolAddress signalProtocolAddress) {
    ...
    try {
      ...
      // Check if a refresh of the signed pre-key is necessary; if so, get a preKeyResponse message.
      ...
      // Catch NoSessionException during encryption.
      ...
      try {
        ...
        // Optionally: start session creation here.
        return null;
      }
      ...
      if (messageEnvelope == null) {
        ...
        // If pre-key response was generated, add the ciphertext to it.
